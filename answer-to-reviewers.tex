...
\medskip
\emph{***We have added some first considerations on the question of how often we have to resort to numerical optimization in Appendix~C,
and now also give computation times for our examples in Section~7.2.}\\
...
to the corresponding jump in either of the component reliability function bounds.}
\medskip
