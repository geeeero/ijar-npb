...
\path (start)     edge[thick]   (T3.west)
      (T3.east)   edge[thick]   (bista)
      (bista)     edge[vh path] (T1-2.west)
      ...
      (T1-5.east) edge[hv path] (biend)
      (T1-6.east) edge[hv path] (biend)
