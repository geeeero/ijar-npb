...
How sensitive is the method to choosing prior (lower, upper) mean near-zero for $p^k_t$ at high $t$'s?***
...
***Vacuous prior sets: $[\yktzl, \yktzu] = (0,1)$ combined with interval $[\nktzl, \nktzu]$)***
