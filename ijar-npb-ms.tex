...
***Another example: simplified automotive brake system, Figure~\ref{fig:brakesystem}.
...
The hand brake mechanism (H) goes directly to two brake pad assemblies P3 and P4;
