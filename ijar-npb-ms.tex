...
As noted in Section~\ref{sec:brakeex}, the grid contained 301 time points and the system has 4 types of components,
...
as they change over time in the brake example from the main body of the paper.
