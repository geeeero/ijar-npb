...
In contrast to previous work on reliability with IP, our focus is on learning component reliabilities***

*** add references to existing work on reliability with IP, including \cite{UC07} here ***

\cite{2011:antonucci::noisyor}
