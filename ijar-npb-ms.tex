...
where we see wider bounds as compared to the other scenarios
...
\begin{figure}
\includegraphics[width=\textwidth]{breakingsystem-1}
\caption{A simplified automotive breaking system. ***System layout goes to empty space in lower row.}
