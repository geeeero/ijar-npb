...
\citep[pp.~123f]{2013:diss-gw}; \citep{Troffaes2013a-short}.
%
...
for data $s^k_t/n_k = 12/16$ (left) and $s^k_t/n_k = 0/16$ (right).
...
\td{Figure with sets of beta cdfs and beta-binom cmfs for conflict and no conflict case.}
